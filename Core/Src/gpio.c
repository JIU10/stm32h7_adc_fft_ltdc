...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOH, Switch_4_Pin|Switch_1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Switch_2_Pin|Switch_3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LCD_BK_GPIO_Port, LCD_BK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PHPin PHPin */
  GPIO_InitStruct.Pin = Switch_4_Pin|Switch_1_Pin;
